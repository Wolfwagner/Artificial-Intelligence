...
def best_first_search(starting_state):
    ...
    while frontier:
        ...
        for neighbor in current_state.get_neighbors():
            distance_to_neighbor = visited_states[current_state][1] 
            if neighbor not in visited_states or distance_to_neighbor < visited_states[neighbor][1]:
                visited_states[neighbor] = (current_state, distance_to_neighbor)
